 ...
 * on 2019/4/30
 */
public class ProgressSuccessFailedView extends View {
	...
	public ProgressSuccessFailedView(Context context) {
		super(context);
	}

	public ProgressSuccessFailedView(Context context, @Nullable AttributeSet attrs) {
		super(context, attrs);
	}

	public ProgressSuccessFailedView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
		super(context, attrs, defStyleAttr);
		TypedArray array = context.getTheme().obtainStyledAttributes(attrs, R.styleable.CustomStatusView, defStyleAttr, 0);
		progressColor = array.getColor(R.styleable.CustomStatusView_progress_color, ContextCompat.getColor(context, R.color.load));
