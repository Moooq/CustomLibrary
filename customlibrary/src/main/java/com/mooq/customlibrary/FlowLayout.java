...
public class FlowLayout extends ViewGroup {
	...
	private void init(AttributeSet attrs){
		...
		mTextSize = array.getDimension(R.styleable.FlowLayout_text_size, 20);
	}
	...
	public void setData(List<String> data){
		...
		setAdapter(data, R.layout.item_flow, new FlowLayout.ItemView<String>() {
			@Override
			void getCover(String item, FlowLayout.ViewHolder holder, View inflate, int position) {
				holder.setText(R.id.tv_item_flow,item);
				TextView textView = (TextView)holder.getView(R.id.tv_item_flow);
